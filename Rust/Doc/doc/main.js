...
(function () {
  var themeChoices = getThemesElement();
  var themePicker = getThemePickerElement();
  var availableThemes = ["ayu", "dark", "light"];
  ...
  function handleThemeButtonsBlur(e) {
    ...
    if (
      active.id !== THEME_PICKER_ELEMENT_ID &&
...
(function () {
    ...
    switch (getVirtualKey(ev)) {
      case "ArrowUp":
        ...
        if (
          ...
          ev.target.id !== THEME_PICKER_ELEMENT_ID
        ) {
  ...
  (function () {
    ...
    if (x.length > 0) {
      x[0].onchange = function () {
        ...
        var selectedVersion =
          document.getElementsByClassName("version-selector")[0].value;
  ...
  window.register_implementors = function (imp) {
    ...
    var traitName = document.querySelector(
      "h1.fqn > .in-band > .trait"
    ).textContent;
    var baseIdName = "impl-" + traitName + "-";
    var libs = Object.getOwnPropertyNames(imp);
    for (var i = 0, llength = libs.length; i < llength; ++i) {
      if (libs[i] === window.currentCrate) {
        continue;
      }
      var structs = imp[libs[i]];
      struct_loop: for (var j = 0, slength = structs.length; j < slength; ++j) {
  ...
  function toggleAllDocs() {
    ...
    if (hasClass(innerToggle, "will-expand")) {
      ...
      onEachLazy(
        document.getElementsByClassName("rustdoc-toggle"),
        function (e) {
  ...
  onEachLazy(
    document.querySelectorAll(".rustdoc-toggle > summary:not(.hideme)"),
    function (el) {
  ...
  onEachLazy(document.getElementsByClassName("notable-traits"), function (e) {
    e.onclick = function () {
      ...
      )[0].classList.toggle("force-tooltip");
    };
  });
  ...
  var buildHelperPopup = function () {
    ...
    rustdoc_version_code.innerText = "rustdoc 1.58.1 (db9d1b20b 2022-01-20)";
